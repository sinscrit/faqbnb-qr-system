/**
 * i18n Configuration for next-intl (Root Level)
 *
 * This is the main next-intl configuration file expected at the project root.
 * It provides the getRequestConfig function required by next-intl for
...
// Supported locales - keep in sync with src/lib/i18n/config.ts
