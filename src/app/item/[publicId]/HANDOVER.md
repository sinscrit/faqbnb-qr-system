...
validation. Phase 3 standalone Playwright mobile/desktop acceptance is the
active gate and follows only after repository `browser-init`.
...
validator accepted Phase 2; Phase 3 browser and Phase 4 database runtime
