...
import { PropertyType, User, CreatePropertyRequest, PropertyTypesResponse, UsersListResponse, PropertyResponse } from '@/types';
...
const NewPropertyPage: React.FC = () => {
  ...
  const loadSupportingData = async () => {
    ...
    try {
      ...
      if (propertiesResponse.ok) {
        ...
        const adminStatus = propertiesData.isAdmin || false;
  ...
  const handleSave = async (propertyData: CreatePropertyRequest) => {
    try {
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-500 md:ml-2">New Property</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="p-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
            ...
            <p className="text-sm text-yellow-600 mt-1">
              No property types are available. Please contact your administrator to set up property types before creating properties.
            </p>
            <button
              onClick={handleCancel}
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Add a new property to {isAdmin ? 'the system' : 'your account'}
          </p>
        </div>
