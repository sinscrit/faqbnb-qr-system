...
const pipelineTests: TestLink[] = [
  {
    href: '/test/faqbnb-review-105',
    title: 'Faqbnb Review 105',
    description: 'Test harness for faqbnb-review-105 pipeline',
  },
  {
    href: '/test/faqbnb-review-109',
    title: 'Faqbnb Review 109',
    description: 'Test harness for faqbnb-review-109 pipeline',
  },
  {
...
const componentTests: TestLink[] = [
  ...
  {
    href: '/test/l10n-epic1-foundation',
    title: 'L10N Epic1 Foundation',
    description: 'Component test page',
  },
  {
    href: '/test/l10n-epic2-static-ui',
    title: 'L10N Epic2 Static Ui',
    description: 'Component test page',
  },
  {
    href: '/test/l10n-epic3-dynamic-content',
    title: 'L10N Epic3 Dynamic Content',
    description: 'Component test page',
  },
  {
    href: '/test/l10n-epic4-guest-experience',
    title: 'L10N Epic4 Guest Experience',
    description: 'Component test page',
  },
  {
    href: '/test/l10n-epic5-owner-management',
    title: 'L10N Epic5 Owner Management',
    description: 'Component test page',
  },
  {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-xs text-gray-400 mt-1">Last updated: 2026-01-31 00:54</p>
        </div>
