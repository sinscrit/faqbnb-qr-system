/**
 * VideoCaptureStep Test Page
 *
 * Manual testing page for the VideoCaptureStep component.
 * Tests full video capture flow: preview, recording, review, accept/retake.
 *
 * @module test/video-capture-step
...
export default function VideoCaptureStepTestPage() {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
          VideoCaptureStep Component Test
        </h1>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6 text-sm text-blue-800 dark:text-blue-200">
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>Recording indicator and timer should appear</li>
            <li>Click "Stop Recording" or wait for auto-stop at max duration</li>
            <li>Review the video - use Accept or Retake</li>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setMaxVideoDuration(parseInt(e.target.value) || 120)}
                min={5}
                max={300}
          ...
          {capturedMedia.length === 0 ? (
            ...
            <div className="space-y-4">
              {capturedMedia.map((media, index) => (
                ...
                >
                  {/* Thumbnail */}
                  <div className="w-24 h-16 bg-gray-200 dark:bg-gray-600 rounded flex items-center justify-center overflow-hidden">
                    {media.thumbnail ? (
                      <img
                  ...
                  <div className="flex-1 text-sm">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Duration: {media.metadata.duration?.toFixed(1) || 'N/A'}s
                    </p>
                    <p className="text-gray-600 dark:text-gray-400">
