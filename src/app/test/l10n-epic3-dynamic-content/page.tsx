...
/**
 * L10N Epic3 Dynamic Content - Pipeline Test Harness
 *
 * Auto-generated LLM-friendly test harness for the l10n-epic3-dynamic-content pipeline.
 * Features:
...
const allTasks = [
    { id: '1.1', request: 'REQ-E03-001', title: 'Create content-translation module structure', status: '✅', hasTest: '' },
    { id: '1.2', request: 'REQ-E03-002', title: 'Implement content translation orchestrator', status: '✅', hasTest: '' },
    { id: '1.3', request: 'REQ-E03-003', title: 'Implement entity-specific translation triggers', status: '✅', hasTest: '' },
    { id: '1.4', request: 'REQ-E03-004', title: 'Implement tag translation trigger', status: '✅', hasTest: '' },
    { id: '1.5', request: 'REQ-E03-005', title: 'Implement translation storage utilities', status: '✅', hasTest: '' },
    { id: '1.6', request: 'REQ-E03-006', title: 'Implement translation status utilities', status: '✅', hasTest: '' },
    { id: '2.1', request: 'REQ-E03-007', title: 'Add source language detection utility', status: '✅', hasTest: '' },
    { id: '2.2', request: 'REQ-E03-008', title: 'Modify Items API to trigger translations', status: '✅', hasTest: '' },
    { id: '2.3', request: 'REQ-E03-009', title: 'Modify Articles API to trigger translations', status: '✅', hasTest: '' },
    { id: '2.4', request: 'REQ-E03-010', title: 'Create/Modify Links API to trigger translations', status: '✅', hasTest: '' },
    { id: '2.5', request: 'REQ-E03-011', title: 'Add tag translation on item save', status: '✅', hasTest: '' },
    { id: '2.6', request: 'REQ-E03-012', title: 'Update TypeScript types for API responses', status: '✅', hasTest: '' },
    { id: '3.1', request: 'REQ-E03-013', title: 'Enhance job processor for content-specific handlin', status: '✅', hasTest: '' },
    { id: '3.2', request: 'REQ-E03-014', title: 'Implement item translation processor', status: '✅', hasTest: '' },
    { id: '3.3', request: 'REQ-E03-015', title: 'Implement article translation processor', status: '✅', hasTest: '' },
    { id: '3.4', request: 'REQ-E03-016', title: 'Implement link translation processor', status: '✅', hasTest: '' },
    { id: '3.5', request: 'REQ-E03-017', title: 'Implement tag translation processor', status: '✅', hasTest: '' },
    { id: '3.6', request: 'REQ-E03-018', title: 'Implement job prioritization', status: '✅', hasTest: '' },
    { id: '3.7', request: 'REQ-E03-019', title: 'Implement concurrency control', status: '✅', hasTest: '' },
    { id: '3.8', request: 'REQ-E03-020', title: 'Implement stale job cleanup', status: '✅', hasTest: '' },
    { id: '4.1', request: 'REQ-E03-021', title: 'Create translation status API endpoint', status: '✅', hasTest: '' },
    { id: '4.2', request: 'REQ-E03-022', title: 'Create retry failed translations endpoint', status: '✅', hasTest: '' },
    { id: '4.3', request: 'REQ-E03-023', title: 'Create manual translation override endpoint', status: '✅', hasTest: '' },
    { id: '4.4', request: 'REQ-E03-024', title: 'Create batch status endpoint for list views', status: '✅', hasTest: '' },
    { id: '5.1', request: 'REQ-E03-025', title: 'Create job processing API route', status: '✅', hasTest: '' },
    { id: '5.2', request: 'REQ-E03-026', title: 'Set up Railway cron job (or alternative)', status: '✅', hasTest: '' },
    { id: '5.3', request: 'REQ-E03-027', title: 'Implement job monitoring endpoint', status: '✅', hasTest: '' },
    { id: '6.1', request: 'REQ-E03-027', title: 'Create translation job indexes', status: '✅', hasTest: '' },
...
export default function L10NEpic3DynamicContentTestPage() {
