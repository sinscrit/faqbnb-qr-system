...
4. **Slice 2C — item/public identity.** The independently statically accepted
   ...
   writes. The independently validated 2C.2 application boundary composes those RPCs with strict
   cookie-bound creation and anonymous two-field public reads without service
   role or self-fetch. Local independent acceptance is complete for 2C.2, and
